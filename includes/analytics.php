...
// includes/analytics.php — Analytics queries for the dashboard
 ...
 */
function getMessagesOverTime(int $days = 14, int $businessId = 0): array
{
    global $mysqli;
 ...
 */
function getStatusBreakdown(): array
{
    global $mysqli;
 ...
 */
function getBusinessBreakdown(int $limit = 8): array
{
    global $mysqli;
 ...
 */
function getTemplatePerformance(): array
{
    global $mysqli;
 ...
 */
function getTopCustomers(int $limit = 5): array
{
    global $mysqli;
