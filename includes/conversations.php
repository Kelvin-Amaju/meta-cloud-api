...
// includes/conversations.php — Inbox conversation threading
 ...
 */
function syncCustomerConversation(int $businessId, string $phone, string $direction, string $preview, ?string $timestamp = null): ?int
{
    global $mysqli;

    $customerId = findOrCreateCustomer($businessId, $phone);
    if ($customerId <= 0) {
        return null;
    }
 ...
 */
function getConversations(array $filters = [], int $page = 1, int $perPage = 20): array
{
    global $mysqli;
 ...
 */
function getConversationById(int $id): ?array
{
    global $mysqli;
 ...
 */
function markConversationRead(int $businessId, int $customerId): bool
{
    global $mysqli;
 ...
 */
function setConversationStatus(int $businessId, int $customerId, string $status): bool
{
    global $mysqli;
 ...
 */
function getUnreadCount(int $businessId = 0): int
{
    global $mysqli;
