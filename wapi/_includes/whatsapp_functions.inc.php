 ...
 */
function whatsapp_send_payload(string $to, array $payload, ?array $tenantCredentials = null): array
{
    global $config;
 ...
 */
function whatsapp_send_text($to, $message, ?array $tenantCredentials = null)
{
    return whatsapp_send_payload($to, [
        'type' => 'text',
        'text' => [
            'preview_url' => false,
            'body' => $message,
 ...
 */
function whatsapp_send_media(string $to, string $mediaType, string $mediaUrl, ?string $caption = null, ?array $tenantCredentials = null): array
{
    ...
    return whatsapp_send_payload($to, $payload, $tenantCredentials);
}

/**
 * Send a WhatsApp template message.
 */
function whatsapp_send_template(string $to, string $templateName, string $languageCode = 'en_US', array $components = [], ?array $tenantCredentials = null): array
{
    $payload = [
        'type' => 'template',
        'template' => [
 ...
 */
function whatsapp_send_interactive_buttons(string $to, string $body, array $buttons, ?array $tenantCredentials = null): array
{
    $payload = [
        'type' => 'interactive',
        'interactive' => [
 ...
 */
function whatsapp_send_interactive_list(string $to, string $headerText, string $body, string $footerText, string $buttonText, array $sections, ?array $tenantCredentials = null): array
{
    $payload = [
        'type' => 'interactive',
        'interactive' => [
 ...
 */
function get_waba_phone_numbers(string $wabaId, ?array $tenantCredentials = null): array
{
    global $config;
