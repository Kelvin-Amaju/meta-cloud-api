 ...
 */
function get_active_businesses(string $status = 'active'): array
{
    return get_businesses(['status' => $status]);
}
 ...
 */
function get_businesses(array $filters = []): array
{
    global $mysqli;
 ...
 */
function get_business_by_uuid(string $uuid): ?array
{
    global $mysqli;
 ...
 */
function get_business_by_phone_number_id(string $phoneNumberId): ?array
{
    global $mysqli;
 ...
 */
function create_business(array $data): array
{
    global $mysqli;
 ...
 */
function update_business(int $id, array $data): array
{
    global $mysqli;

    $existing = get_business($id);
    if (!$existing) {
 ...
 */
function delete_business(int $id): bool
{
    global $mysqli;
 ...
 */
function get_business_summary_stats(): array
{
    global $mysqli;
