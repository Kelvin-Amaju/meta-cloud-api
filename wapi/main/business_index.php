...
// business_index.php — Business Directory & Overview (ported from business/index.php)
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'create') {
        ...
        $id = (int)($_POST['id'] ?? 0);
        $result = update_business($id, $_POST);
        $flash = $result['success']
        ...
        $result = update_business($id, ['status' => $newStatus]);
        $flash = $result['success']
    ...
    header('Location: business_index');
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'delete') {
    ...
    $targetBiz = get_business($deleteId);

    if ($targetBiz && delete_business($deleteId)) {
        $alert = [
            'type'    => 'success',
...
$businesses = get_businesses($filters);
$stats      = get_business_summary_stats();
?>
<!DOCTYPE html>
<html lang="en">
...
<body class="bg-light min-vh-100 d-flex flex-column">
    ...
    <div class="container-fluid container-xl mb-5 my-auto">
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-4 mt-5">
            ...
            <div>
                <a href="business_add" class="btn btn-ng-secondary btn shadow-sm d-flex align-items-center gap-2">
        ...
        <?php require __DIR__ . '/../_includes/messaging_limit_banner.inc.php'; ?>
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-body p-3">
                <form method="get" action="business_index" class="row g-2 align-items-center">
                    ...
                    <div class="col-12 col-md-2 d-flex gap-2">
                        ...
                        <a href="business_index" class="btn btn-ng-black" title="Reset Filters">
        ...
        <div class="card border-0 shadow-sm">
            ...
            <?php if (empty($businesses)): ?>
                <div class="card-body text-center py-5 text-muted">
                    ...
                    <a href="business_add" class="btn btn-dark btn-sm px-4">Add Business Profile</a>
                </div>
            <?php else: ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end pe-4">
                                        <div class="btn-group btn-group-sm">
                                            <a href="business_view?id=<?= $b['id'] ?>" class="btn btn-outline-secondary" title="View Profile">
                                                <i class="bi bi-eye"></i>
                                            </a>
                                            <a href="business_edit?id=<?= $b['id'] ?>" class="btn btn-outline-primary" title="Edit Profile">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form method="post" action="business_index">
