...
// settings_whatsapp.php — WhatsApp Settings (ported from settings/whatsapp.php)
...
$businesses = get_businesses(['status' => 'all']);
    ...
    <div class="mt-5 container py-2 flex-grow-1" style="max-width:1200px;">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
            ...
            <div class="d-flex gap-2">
                <a href="business_add" class="btn btn-ng-primary btn-sm fw-semibold">
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-end">
                                    ...
                                    <a href="business_edit?id=<?= (int)$biz['id'] ?>" class="btn btn-ng-outline btn-sm">
                        ...
                        <?php if (count($businesses) === 0): ?>
                            <tr>
                                <td colspan="7" class="text-center text-muted py-4">
                                    No businesses yet — <a href="business_add" class="fw-semibold">add your first business</a>.
                                </td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
