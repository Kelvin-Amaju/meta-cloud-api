...
// business_view.php — View Business Profile & Configuration Details (ported from business/view.php)
...
$messagesResult = get_messages(['business_id' => $business['id']], 1, 5);
    ...
    <div class="container my-auto" style="max-width: 960px;">
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-4">
            ...
            <div class="d-flex align-items-center gap-2">
                <a href="business_edit?id=<?= $business['id'] ?>" class="btn btn-outline-primary shadow-sm">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div>
                            ...
                            <div class="form-text">Stored server-side. Token value is masked — use Edit Profile to rotate it.</div>
                        </div>
                    </div>
                </div>
