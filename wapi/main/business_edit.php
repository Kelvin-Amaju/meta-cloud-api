...
// business_edit.php — Edit / Update WhatsApp Business Profile (ported from business/edit.php)
...
$business   = $businessId > 0 ? get_business($businessId) : null;
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $updateResult = update_business($businessId, $_POST);
...
<body class="bg-light min-vh-100 d-flex flex-column py-4">
    ...
    <div class="container my-auto" style="max-width: 860px;">
        ...
        <div class="card border-0 shadow-sm rounded-3">
            <div class="card-body p-4 p-md-5">
                ...
                <form action="business_edit?id=<?= $business['id'] ?>" method="POST">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-6">
                            <label for="waba_id2" class="form-label fw-semibold">WABA ID (Account ID)</label>
                            <div class="input-group">
                                <span class="input-group-text bg-light text-muted"><i class="bi bi-qr-code"></i></span>
                                <input
                                    type="text"
                    ...
                    <div class="d-flex align-items-center justify-content-between pt-3 border-top">
                        <a href="business_view?id=<?= $business['id'] ?>" class="btn btn-outline-secondary px-4">Cancel</a>
    ...
    <script>
        ...
        const wabaIdInput = document.getElementById('waba_id2');
